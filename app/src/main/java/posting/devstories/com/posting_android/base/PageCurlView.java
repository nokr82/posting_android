...
public class PageCurlView extends View {
	...
	private int mCurlMode = CURLMODE_SIMPLE;
	...
	private boolean bFlipRight = true;
    ...
    public void setmForeground(Bitmap mForeground) {
        mPages.add(mForeground);
        this.mForeground = mForeground;
    }

    public void setmBackground(Bitmap mBackground) {
        mPages.add(mBackground);
        this.mBackground = mBackground;
    }

    public void setbFlipping(boolean bFlipping) {
        this.bFlipping = bFlipping;
    }
	...
	public final void init(Context context) {
		...
		// mPages.add(BitmapFactory.decodeResource(getResources(), R.drawable.chat));
		// mPages.add(BitmapFactory.decodeResource(getResources(), R.drawable.chat2));
		
		// Create some sample images
		// mForeground = mPages.get(0);
		// mBackground = mPages.get(1);

        // mForeground = BitmapFactory.decodeResource(getResources(), R.drawable.chat);
        // mBackground = BitmapFactory.decodeResource(getResources(), R.drawable.chat);
	}
