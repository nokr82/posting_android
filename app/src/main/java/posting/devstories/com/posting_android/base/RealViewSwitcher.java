 ...
 * <p>
 * You can add and remove views using the normal methods {@link ViewGroup#addView(View)}, {@link ViewGroup#removeView(View)} etc. You may want to listen for updates by calling {@link com.babycarestory.babycarestory.RealViewSwitcher#setOnScreenSwitchListener(com.babycarestory.babycarestory.RealViewSwitcher.OnScreenSwitchListener)}
...
public class RealViewSwitcher extends ViewGroup {
    ...
    /**
     * Sets the {@link android.widget.ViewSwitcher.OnScreenSwitchListener}.
     * 
